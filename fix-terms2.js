      ...
      <main style={{ paddingBottom: '64px' }}>
        <LegalPage
          ...
          sections={[
            ...
            { title: 'Website Purpose', content: 'This website is owned and operated by the clinic. It is intended to provide general information about the clinic services, facilities, doctors, and treatment options. The content on this website is for informational purposes only.' },
            ...
            { title: 'Appointment Requests', content: 'Submitting an appointment request through this website does not guarantee an appointment. All requests are subject to confirmation by the Clinic. The Clinic reserves the right to accept or decline any appointment request.' },
            { title: 'Intellectual Property', content: 'All content on this website including text, images, logos, graphics, and design is the property of the clinic and is protected by applicable intellectual property laws. Unauthorised use is strictly prohibited.' },
            ...
            { title: 'Contact', content: 'For any questions about these terms, please contact us directly at the clinic.' },
          ]}
        />
