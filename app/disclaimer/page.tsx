      ...
      <main style={{ paddingBottom: '64px' }}>
        <LegalPage
          ...
          sections={[
            ...
            { title: 'Professional Judgement', content: 'The doctors and healthcare professionals at this Clinic exercise their professional judgement when recommending treatments. Treatment plans are personalised and based on thorough clinical evaluation. The Clinic is not liable for decisions made by patients based solely on website content without a formal consultation.' },
