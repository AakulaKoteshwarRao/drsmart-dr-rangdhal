        ...
        <div className="sec-pad">
          <div style={{{{ display: \'grid\', gridTemplateColumns: \'1fr 1fr\', gap: \'2rem\', alignItems: \'start\' }}}}>
            <div>
              ...
              <a href={{(clinic as any).googleDirectionsUrl ?? (clinic as any).mapsUrl ?? \'#\'}} target="_blank" rel="noopener noreferrer"
        ...
        <div className="sec-pad" style={{{{ textAlign: \'center\' }}}}>
          ...
          <div className="contact-social-links">
            {{(clinic as any).social?.google && (
              <a href={{(clinic as any).social.google}} className="contact-social-link" target="_blank" rel="noopener noreferrer">Google</a>
            )}}
            {{(clinic as any).social?.facebook && (
              <a href={{(clinic as any).social.facebook}} className="contact-social-link" target="_blank" rel="noopener noreferrer">Facebook</a>
            )}}
            {{(clinic as any).social?.instagram && (
              <a href={{(clinic as any).social.instagram}} className="contact-social-link" target="_blank" rel="noopener noreferrer">Instagram</a>
            )}}
            {{(clinic as any).social?.youtube && (
              <a href={{(clinic as any).social.youtube}} className="contact-social-link" target="_blank" rel="noopener noreferrer">YouTube</a>
            )}}
          </div>
        </div>
      </div>
