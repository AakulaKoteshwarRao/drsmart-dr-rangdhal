    ...
    <>
      ...
      <main style={{ paddingBottom: '64px' }}>
        <LegalPage
          ...
          sections={[
            { title: 'Overview', content: 'The clinic is committed to protecting your privacy. This policy explains how we collect, use, store, and protect your personal information when you use our website or services.' },
            ...
            { title: 'Patient Data & Consent', content: 'Patient testimonials, reviews, success stories, and before/after images are published only with explicit written consent from the patient. Patients may request removal of their content at any time by contacting the Clinic.' },
