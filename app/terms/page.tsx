      ...
      <main>
        <LegalPage
          ...
          sections={[
            ...
            { title: 'Website Purpose', content: "This website is owned and operated by the clinic. It is intended to provide general information about the Clinic's services, facilities, doctors, and treatment options. The content on this website is for informational purposes only." },
