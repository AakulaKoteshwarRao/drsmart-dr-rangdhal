...
const credSections = (doctor: DoctorInfo, clinic: ClinicInfo) => [
  ...
  { num: '09', grad: 'linear-gradient(135deg,var(--primary),var(--primary-dark))', title: 'Medical Registration', sub: 'Verified Registration', items: [{ title: `Registration No. ${doctor.nmcNumber}`, sub: 'National Medical Commission · Verified & Active' }, { title: `${doctor.registrationState || 'State'} Medical Council Registration`, sub: doctor.registrationState ? `${doctor.registrationState} Medical Council` : 'State Medical Council' }] },
